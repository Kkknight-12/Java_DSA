package Questions.ArraysQuestions.Easy.Arrays.TwoNumbersAddUptoN;

/* we are using Quick Sort Algorithm to sort the array */

public class TwoNumbersAddUptoNSolution {
    ...
    public static void sort(int[] arr, int low, int high) {
        // Recursive call to sort function if low < high
        // also recursive call to partition function
        if ( low < high ) {

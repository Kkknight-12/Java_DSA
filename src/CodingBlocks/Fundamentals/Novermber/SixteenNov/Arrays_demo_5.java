...
public class Arrays_demo_5 {
    public static void main(String[] args) {
         ...
         * swapped inside the swap function but after the function is popped
         * from stack the address whose value was taken to swap remain same
         * as no change was don't to address */
        swap(a1[0], a2[0]);
        System.out.println(a1[0] + ":" + a2[0]); // 1 : 22

        // same applies to array swapping logic
        /*  a and b are local variable in swap_arr function
         * so when the function is popped from stack, changes made don't
         * affect real array*/
        System.out.println(a1 + " : " + a2); // [I@8efb846 : [I@2a84aee7
        swap_arr(a1, a2);
        System.out.println(a1 + " : " + a2); // [I@8efb846 :
        // [I@2a84aee7
    }

package Questions.ArraysQuestions.TwoPointer.TargetSumTriplet;
...
*
Explanation
* Array = {5, 7, 9, 1, 2, 4, 6 ,8 ,3}. Target number = 10. Find any three
* number in the given array which sum to target number.
*  */

public class TargetSumTriplet_Brute_force {
